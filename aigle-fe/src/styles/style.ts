...
const globalStyles = css`
  ...
  .ant-layout-sider {
    ...
    .ant-tree-treenode {
      ...
      :active {
        cursor: pointer !important;
        background-color: ${COLOR_PALETTE.AIGLE_MENU_SELECTED_BG}!important;
      }
      /* .ant-tree-title {
        width: 100%!important;
      } */
  ...
  .ant-select {
    border-radius: ${MEASUREMENT.AIGLE_BORDER_RADIUS_BASE}!important;
    background-color: ${COLOR_PALETTE.AIGLE_INPUT_BACKGROUND}!important;
  ...
  .ant-card {
    box-shadow: 5px 5px 10px ${COLOR_PALETTE.AIGLE_HEADER_SEARCH_BG_HOVER};
  ...
  .ant-modal-content {
    border-radius: ${MEASUREMENT.AIGLE_MODAL_BORDER_RADIUS}!important;
  }
  .ant-modal-header {
